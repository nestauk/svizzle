import { a_ as reduceWith, a$ as allOf, b0 as isGTE, b1 as isLTE, b2 as identity, aj as sort, b3 as adapter, b4 as map, T as pipe, b5 as reduce, b6 as isNotNil, b7 as isIterableNotEmpty, b8 as every, b9 as hasKey, R as getKey, N as mapWith, ba as flatten, aX as getPath, bb as collect, bc as findIndexWhere, bd as findLastIndexWhere, be as slice, ak as uniques, aS as sortWith, bf as filterWith, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, a9 as createEventDispatcher, aa as validate_store, ab as component_subscribe, ac as writable, a6 as makeStyleVars, ad as concat, ae as mergeObj, af as appendTo, ah as last, ai as pullFrom, I as svg_element, J as claim_svg_element, g as children, b as detach_dev, j as attr_dev, H as toggle_class, l as add_location, m as insert_hydration_dev, a1 as empty, o as noop, p as validate_each_argument, $ as listen_dev, n as append_hydration_dev, y as destroy_each, t as text, h as claim_text, Z as set_data_dev, al as is_function, am as run_all, e as element, f as claim_element, C as create_component, D as claim_component, E as mount_component, u as transition_in, w as transition_out, F as destroy_component, a as space, c as claim_space, a7 as add_render_callback, a8 as add_resize_listener, G as group_outros, x as check_outros, a0 as bubble, K as Icon } from './client.5c29960b.js';
import { i as inclusiveRange, b as getValues, c as getFirstAndLast, l as linear } from './yootils.es.6e4269de.js';
import { e as extent, p as pairs } from './Info.c6802fb5.js';
import { d as defaultRel } from './linear.ec33a939.js';
...
/* ../../components/legend/src/ColorBinsG.svelte generated by Svelte v3.44.2 */
...
function create_else_block$1(ctx) {
	...
	let if_block3 = /*isBrushing*/ ctx[8] && create_if_block_2$1(ctx);
...
function create_if_block_5(ctx) {
	...
	const block = {
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty[0] & /*bars*/ 512 && rect_height_value !== (rect_height_value = /*barHeight*/ ctx[55])) {
				attr_dev(rect, "height", rect_height_value);
			}

			if (dirty[0] & /*bars*/ 512 && rect_width_value !== (rect_width_value = /*barWidth*/ ctx[54])) {
				attr_dev(rect, "width", rect_width_value);
			}
		},
		d: function destroy(detaching) {
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*bars*/ 512 && rect_fill_value !== (rect_fill_value = /*fill*/ ctx[56])) {
			...
			if (dirty[0] & /*bars*/ 512 && g_transform_value !== (g_transform_value = "translate(" + /*x*/ ctx[50] + "," + /*y*/ ctx[51] + ")")) {
...
function create_fragment$9(ctx) {
	let if_block_anchor;
	let if_block = /*height*/ ctx[6] && /*width*/ ctx[7] && create_if_block$2(ctx);
...
function instance$9($$self, $$props, $$invalidate) {
	...
	component_subscribe($$self, _brush, value => $$invalidate(41, $_brush = value));
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty[0] & /*geometry, flags, theme*/ 38) {
			$$invalidate(40, widgetThickness = geometry.barThickness + (flags.showTicks
			? flags.isVertical
				? 0
		...
		if ($$self.$$.dirty[0] & /*geometry, flags*/ 6 | $$self.$$.dirty[1] & /*innerWidth, widgetThickness, innerHeight*/ 896) {
		...
		if ($$self.$$.dirty[0] & /*flags, geometry*/ 6 | $$self.$$.dirty[1] & /*innerWidth, innerHeight*/ 384) {
		...
		if ($$self.$$.dirty[0] & /*flags*/ 2 | $$self.$$.dirty[1] & /*innerHeight, innerWidth*/ 384) {
			$$invalidate(36, range = flags.isVertical ? [innerHeight, 0] : [0, innerWidth]);
		}

		if ($$self.$$.dirty[1] & /*valuesExtent, range*/ 96) {
		...
		if ($$self.$$.dirty[0] & /*isBrushing*/ 256 | $$self.$$.dirty[1] & /*$_brush*/ 1024) {
			$$invalidate(30, brushExtent = isBrushing && sort([$_brush.start, $_brush.end]));
		}

		if ($$self.$$.dirty[0] & /*isBrushing, brushExtent*/ 1073742080) {
		...
		if ($$self.$$.dirty[0] & /*isBrushing, doesBrushAdd, selectedBins, brushRange, doesBrushRemove*/ 369099024 | $$self.$$.dirty[1] & /*$_brush*/ 1024) {
			if (isBrushing) {
		...
		if ($$self.$$.dirty[0] & /*bins, selectedBins, flags, geometry, theme*/ 55 | $$self.$$.dirty[1] & /*scale, semigap, lastIndex*/ 26) {
		...
		if ($$self.$$.dirty[0] & /*flags, bins*/ 3) {
			$$invalidate(33, ticksValues = flags.showTicksExtentOnly
			? getBinsTicksExtent(bins)
			: getBinsTicks(bins));
		}

		if ($$self.$$.dirty[0] & /*ticksFormatFn, flags*/ 16777218 | $$self.$$.dirty[1] & /*ticksValues, ticksDistance, scale*/ 7) {
		...
		if ($$self.$$.dirty[0] & /*doesBrushAdd, theme, doesBrushRemove*/ 100663328) {
			$$invalidate(27, brushStroke = doesBrushAdd
			? theme.brushAddStroke
			: doesBrushRemove ? theme.brushRemoveStroke : null);
		}

		if ($$self.$$.dirty[0] & /*isBrushing, bars, brushExtent*/ 1073742592) {
			$$invalidate(29, brushExtentBarYs = isBrushing && sort([
		...
		if ($$self.$$.dirty[0] & /*isBrushing, brushExtentBarYs*/ 536871168) {
		...
		if ($$self.$$.dirty[0] & /*theme, brushStroke*/ 134217760) {
			/* style */
...
/* ../../components/legend/src/ColorBinsDiv.svelte generated by Svelte v3.44.2 */
...
/* ../../components/ui/src/icons/feather/CheckSquare.svelte generated by Svelte v3.44.2 */
...
/* ../../components/ui/src/icons/feather/ChevronDown.svelte generated by Svelte v3.44.2 */
...
/* ../../components/ui/src/icons/feather/ChevronUp.svelte generated by Svelte v3.44.2 */
...
/* ../../components/ui/src/icons/feather/Globe.svelte generated by Svelte v3.44.2 */
...
/* ../../components/ui/src/icons/feather/MinusSquare.svelte generated by Svelte v3.44.2 */

const file$3 = "../../components/ui/src/icons/feather/MinusSquare.svelte";
...
/* ../../components/ui/src/icons/feather/Square.svelte generated by Svelte v3.44.2 */

const file$2 = "../../components/ui/src/icons/feather/Square.svelte";
...
/* ../../components/ui/src/LinkButton.svelte generated by Svelte v3.44.2 */
const file$1 = "../../components/ui/src/LinkButton.svelte";
...
function create_if_block(ctx) {
	...
	let if_block1 = /*glyph*/ ctx[9] && create_if_block_1(ctx);
...
/* ../../components/ui/src/MessageView.svelte generated by Svelte v3.44.2 */

const file = "../../components/ui/src/MessageView.svelte";
