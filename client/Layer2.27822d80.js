import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, ba as getContext, ak as validate_store, at as component_subscribe, I as svg_element, a as space, t as text, J as claim_svg_element, g as children, b as detach_dev, c as claim_space, j as claim_text, k as attr_dev, m as add_location, n as insert_hydration_dev, o as append_hydration_dev, p as noop } from './client.c587a315.js';

/* src/routes/compounds/mapbox/components/Layer2.svelte generated by Svelte v3.58.0 */
...
function instance($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Layer2> was created with unknown prop '${key}'`);
	});
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*$_bbox, $_projectFn, x1, y1*/ 983040) {
			...
			($$invalidate(0, { x: xp1, y: yp1 } = $_projectFn?.([x1, y1]), xp1, ((((($$invalidate(8, yp1), $$invalidate(19, $_bbox)), $$invalidate(18, $_projectFn)), $$invalidate(17, x1)), $$invalidate(16, y1)), $$invalidate(7, wsen))));
		}

		if ($$self.$$.dirty & /*$_bbox, $_projectFn, x2, y2*/ 835584) {
			// eslint-disable-next-line no-unused-expressions, no-sequences
			($$invalidate(1, { x: xp2, y: yp2 } = $_projectFn?.([x2, y2]), xp2, ((((($$invalidate(9, yp2), $$invalidate(19, $_bbox)), $$invalidate(18, $_projectFn)), $$invalidate(15, x2)), $$invalidate(14, y2)), $$invalidate(7, wsen))));
		}
...
class Layer2 extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance, create_fragment, safe_not_equal, { wsen: 7 });
