import { l as apply, k as pipe, I as collect, al as getLength, am as divide, u as mapWith, a2 as reduceWith, an as sum, w as getKey, ak as is, p as partial, _ as __, ao as pluck, ac as flatten, ap as transpose, aq as makeArrayTransformer, o as indexBy, a1 as getPath, ar as pickIf, P as identity, t as keys, m as mapValuesWith, a6 as adapter, as as casus, j as format, a3 as allOf, ab as hasKey, at as not } from './defaultLocale.3cc8e503.js';
import { a9 as derived, U as writable, aa as readable, ab as get_store_value } from './client.0cc30d5f.js';
import { g as getValue, s as sliceString, i as inclusiveRange, _ as _screen, l as linear, e as joinWithBlank } from './ScreenGauge.12bb7888.js';
...
const _POIs = writable();
const setPOIs = POIs => _POIs.set(POIs);
...
const _navFlags = writable(defaultFlags);
const setNavFlags = flags => _navFlags.set(flags);

// hrefBase

const _hrefBase = writable('');
const setHrefBase = href => _hrefBase.set(href);
