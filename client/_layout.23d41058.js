...
function create_each_block_1$1(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*$_theme*/ 64) hyperlink_changes.theme = { color: /*$_theme*/ ctx[6].colorWhite };
