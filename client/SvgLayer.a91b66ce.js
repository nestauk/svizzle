import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, r as create_slot, v as validate_slots, ba as getContext, ak as validate_store, at as component_subscribe, I as svg_element, J as claim_svg_element, g as children, b as detach_dev, k as attr_dev, bU as set_style, H as toggle_class, m as add_location, n as insert_hydration_dev, av as action_destroyer, y as update_slot_base, z as get_all_dirty_from_scope, A as get_slot_changes, u as transition_in, B as transition_out, aw as binding_callbacks } from './client.c587a315.js';

/* ../../components/mapbox/src/SvgLayer.svelte generated by Svelte v3.58.0 */
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			svg = claim_svg_element(nodes, "svg", { class: true, style: true });
...
function instance($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<SvgLayer> was created with unknown prop '${key}'`);
	});
...
class SvgLayer extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance, create_fragment, safe_not_equal, { isInteractive: 0, order: 1 });
