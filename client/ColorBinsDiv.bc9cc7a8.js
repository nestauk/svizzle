...
function create_each_block$1(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			span = claim_element(nodes, "SPAN", { role: true, tabindex: true, class: true });
			var span_nodes = children(span);
...
function create_else_block(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			g0 = claim_svg_element(g1_nodes, "g", { class: true, role: true });
