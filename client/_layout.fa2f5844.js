import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, q as validate_each_argument, r as create_slot, v as validate_slots, e as element, a as space, f as claim_element, g as children, b as detach_dev, c as claim_space, k as attr_dev, m as add_location, n as insert_hydration_dev, o as append_hydration_dev, u as transition_in, w as group_outros, x as check_outros, y as update_slot_base, z as get_all_dirty_from_scope, A as get_slot_changes, B as transition_out, C as destroy_each, D as create_component, E as claim_component, F as mount_component, G as destroy_component, t as text, j as claim_text, H as toggle_class } from './client.c587a315.js';
import { L as Link } from './Link.8362b490.js';

/* src/routes/compounds/mapbox/_layout.svelte generated by Svelte v3.58.0 */
...
// (12:3) <Link     href='compounds/mapbox/{example}'     rel='prefetch'    >
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(12:3) <Link     href='compounds/mapbox/{example}'     rel='prefetch'    >",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(nav, file, 9, 1, 181);
			attr_dev(main, "class", "svelte-1j7t2sn");
			add_location(main, file, 21, 1, 389);
			attr_dev(section, "class", "svelte-1j7t2sn");
			add_location(section, file, 8, 0, 170);
		},
		m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ Link, segment, examples });
