import { a2 as partial, a3 as __, cr as apply, Z as pipe, ag as collect, cs as getLength, aj as reduceWith, ct as sum, cu as pluck, c7 as flatten, cv as indexBy, ah as getPath, cw as transpose, cx as derived, be as writable, az as _screen, c1 as adapter, cy as casus, cz as isNil, b_ as allOf, ci as isKeyValue, c6 as hasKey, bY as not, bO as identity, cA as getTruthyValuesKeys, cB as joinWithBlank, _ as mapValuesWith, bk as readable } from './client.9324a931.js';
import { s as sliceString, c as arraySumWith, i as inclusiveRange, l as linear } from './linear.f307c541.js';
import { g as getValue, m as makeArrayTransformer, b as format } from './defaultLocale.a39c0f65.js';
 ...
 * @since 0.11.0
 */
pipe([collect([arraySum, getLength]), _ref2 => {
  let [sum, length] = _ref2;
 ...
 * @since 0.11.0
 */
const keyValueArrayAverage = pipe([collect([arraySumWith(getValue), getLength]), _ref3 => {
  let [sum, length] = _ref3;
  return length ? sum / length : 0;
}]);
...
const makeIndicatorsLookup = pipe([pluck('indicators'), flatten, indexBy(getPath('schema.value.id'))]);
...
const getYearExtent = pipe([pluck('indicators'), flatten, pluck('year_extent'), transpose, makeArrayTransformer([arrayMin, arrayMax])]);
...
const _isSmallScreen = derived(_screen, s => s && s.sizes.small && !s.sizes.medium);
const _screenClasses = derived(_screen, s => s === null || s === void 0 ? void 0 : s.classes);
const _glyph = derived(_screen, s => s === null || s === void 0 ? void 0 : s.glyph);
...
const _safety = derived(_isSmallScreen, isSmall => isSmall ? smallSafety : largeSafety);

/* timeline */

const _timelineHeight = writable(0);
const _timelineWidth = writable(0);
const _timelineLayout = derived([_safety, _timelineHeight, _timelineWidth, _yearExtent$1], _ref => {
  let [safety, height, width, yearExtent] = _ref;
  const padding = 10;
  const fontSize = Math.min(height / 4, 14);
  const radius = Math.min(height / 8, 7);
  const fullExtent = [padding + radius, width - padding - radius];
...
const makeGetIndicatorFormatOf = id => pipe([getPath("".concat(id, ".schema.value")), adapter([casus(isNil, getIdentity), casus(allOf([isKeyValue(['data_type', 'int']), hasKey('format')]), value => pipe([Math.round, format(value.format)])), casus(allOf([isKeyValue(['data_type', 'int']), not(hasKey('format'))]), () => Math.round), casus(hasKey('format'), value => format(value.format)), getIdentity])]);
const makeGetRefFormatOf = id => pipe([getPath("".concat(id, ".schema.value")), adapter([casus(isNil, getIdentity), casus(allOf([isKeyValue(['data_type', 'int']), hasKey('format')]), value => pipe([Math.round, format(value.format)])), casus(isKeyValue(['data_type', 'int']), () => Math.round), casus(hasKey('format'), value => format(value.format)), getIdentity])]);
...
const _isTimelineHidden = derived([_isSmallScreen, _views], _ref => {
  let [isSmall, views] = _ref;
  return isSmall && (views.info || views.settings);
});

/* flags */

const _navFlags = writable({
  showPOIs: false
});
...
var groups = [{
  ...
  "indicators": [{
    ...
    "api_type": "FETCH",
    "availableYears": [2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017],
    "data_date": "205016",
    ...
    "order": ["year", "region_type", "region_year_spec", "region_id", "region_level", "value.id"],
    "region_types": ["NUTS"],
    "schema": {
      "region_id": "string",
      "region_level": "int",
    ...
    "year_extent": [2008, 2017]
  }, {
    "api_doc_url": "http://vidtawah.am/lo",
    "api_type": "FETCH",
    "availableYears": [2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017],
    "data_date": "2070722",
    ...
    "year_extent": [2009, 2017]
  }, {
    "api_doc_url": "http://met.gd/gofuwim",
    "api_type": "FETCH",
    "availableYears": [2008, 2009, 2010, 2011, 2012],
    "data_date": "202947",
    ...
    "year_extent": [2008, 2012]
  }, {
    "api_doc_url": "http://lov.na/lofameh",
    "api_type": "FETCH",
    "availableYears": [2011, 2012, 2013],
    "data_date": "2076229",
    ...
    "year_extent": [2011, 2013]
  }, {
    "api_doc_url": "http://riseev.pa/ki",
    "api_type": "FETCH",
    "availableYears": [2008, 2009, 2010, 2011, 2012, 2013],
    "data_date": "2058812",
  ...
  "indicators": [{
    ...
    "api_type": "FETCH",
    "availableYears": [2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015],
    "data_date": "2095913",
    ...
    "year_extent": [2006, 2015]
  }, {
    "api_doc_url": "http://delkotop.nz/vatitgud",
    "api_type": "FETCH",
    "availableYears": [2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016],
    "data_date": "2096416",
    ...
    "year_extent": [2006, 2016]
  }, {
    "api_doc_url": "http://sotge.net/lak",
    "api_type": "FETCH",
    "availableYears": [2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016],
    "data_date": "21091026",
  ...
  "indicators": [{
    ...
    "api_type": "FETCH",
    "availableYears": [2007, 2008, 2009, 2010, 2011, 2012],
    "data_date": "2088621",
  ...
  "indicators": [{
    ...
    "api_type": "FETCH",
    "availableYears": [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017],
    "data_date": "2116124",
    ...
    "year_extent": [2010, 2017]
  }, {
    "api_doc_url": "http://liuzdi.sz/jihi",
    "api_type": "FETCH",
    "availableYears": [2010, 2011, 2012],
    "data_date": "206916",
    ...
    "year_extent": [2010, 2012]
  }, {
    "api_doc_url": "http://sa.ba/eco",
    "api_type": "FETCH",
    "availableYears": [2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015],
    "data_date": "21081231",
    ...
    "api_type": "FETCH",
    "availableYears": [2007, 2008, 2009, 2010, 2011, 2012, 2013],
    "data_date": "2066313",
    ...
    "year_extent": [2007, 2013]
  }, {
    "api_doc_url": "http://litfoma.is/wocpezkav",
    "api_type": "FETCH",
    "availableYears": [2011, 2012, 2013, 2014, 2015],
    "data_date": "20231023",
  ...
  "indicators": [{
    ...
    "api_type": "FETCH",
    "availableYears": [2011, 2012, 2013, 2014],
    "data_date": "207627",
    ...
    "year_extent": [2011, 2014]
  }, {
    "api_doc_url": "http://zistiuce.bo/sizameg",
    "api_type": "FETCH",
    "availableYears": [2010, 2011, 2012, 2013],
    "data_date": "2032513",
