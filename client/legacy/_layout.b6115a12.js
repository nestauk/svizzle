import { Y as map$1, cv as isKeyValue, bJ as pullFrom, R as keys, cw as difference, cx as union, $ as head, cy as intersection, a5 as objectToKeyValueArray, cz as pickIn, bE as identity$1, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, aC as _, bx as set_store_value, p as noop$2, aA as subscribe, q as validate_each_argument, ax as validate_store, aJ as component_subscribe, aF as onMount, e as element, f as claim_element, g as children, b as detach_dev, k as attr_dev, aT as add_render_callback, m as add_location, n as insert_hydration_dev, aU as add_iframe_resize_listener, u as transition_in, w as group_outros, x as check_outros, B as transition_out, C as destroy_each, aG as binding_callbacks, t as text, a as space, j as claim_text, c as claim_space, o as append_hydration_dev, ah as set_data_dev, D as create_component, E as claim_component, F as mount_component, G as destroy_component, H as toggle_class, aL as action_destroyer, aV as is_function, bs as isServerSide, aR as isNotNil, a8 as last$1, aS as findIndex, aW as is, ce as when, a2 as always, I as svg_element, aE as empty, J as claim_svg_element, L as Icon, a4 as mapValuesWith, M as listen_dev, az as run_all, br as ScreenSensor, aw as isClientSide, cf as bind$1, r as create_slot, cg as add_flush_callback, y as update_slot_base, z as get_all_dirty_from_scope, A as get_slot_changes, h as head_selector } from './client.c3033a77.js';
import { L as LoadingView } from './topojson.7e686ee0.js';
import { n as noop$1 } from './any-undefined.7e669ab1.js';
import { d as getKey } from './defaultLocale.cc2e245b.js';
import { a as rxStreamToSvWritable, r as rxStreamToSvReadable, L as List, A as Activity, B as BarChart, C as Clock, M as MapPin } from './rx.e43eac44.js';
import { H as HyperLink } from './HyperLink.47b34ea4.js';
import { _ as _hrefBase, s as setGroups, a as _timelineLayout, b as _yearRange, c as shortenYear, d as _routes, e as _isSmallScreen, f as _screenClasses, g as _viewsClasses, h as _isTimelineHidden, i as _timelineWidth, j as _timelineHeight, k as _selectedYear, l as _navFlags, m as _views, n as showView, o as _groups } from './stores.c78e13af.js';
import { _ as _theme, a as _style, b as _availableYears, c as _regionSettings, d as customizeTheme } from './indicator.6579e841.js';
import { m as makeURL, f as flags, h as hrefBase, r as regionSettings } from './_config.1ab7ff90.js';
import { I as Info } from './Info.5098ebd2.js';
import { S as Settings } from './Settings.c67a6927.js';
import { _ as _topojsonPriorities, a as _topoCache, b as _loadingTopojsonKeys, c as _uriMap, d as _POIs } from './POIs.9cc344e1.js';
import './linear.1b91202b.js';
import './rgb.6ffaf778.js';
 ...
 * @since 0.14.0
 */
const truthynessTo = _ref => {
  let [valueIfTruthy, valueIfFalsy] = _ref;
  return x => x ? valueIfTruthy : valueIfFalsy;
};
...
const exportedObjBufferToAny = function (buffer) {
...
const derive = (_ref, fn) => {
  let [first, ...rest] = _ref;
  return first.pipe(combineLatestWith(...rest), debounceTime(0), map(fn), share());
};

const makeSideEffectors = _ref => {
  let {
    _outEvents,
    downloadFn
  } = _ref;
  ...
  const startDownload = async _ref2 => {
    let [[uris, groupId], fetchingOrFetchedTargetKeys] = _ref2;
    ...
    let cancelledKeys = [];
    await Promise.all(uris.map(async _ref3 => {
      let {
        key,
        value
      } = _ref3;
...
const createFetchManagerStreams = downloadFn => {
  ...
  const _allKeys = _uriMap.pipe(map(keys), share());
  const _restKeys = derive([_allKeys, _asapKeys, _nextKeys, _runChain], _ref => {
    let [allKeys, asapKeys, nextKeys] = _ref;
    return difference(allKeys, union(asapKeys, nextKeys));
  });
  const _groups = _restKeys.pipe(withLatestFrom(_asapKeys, _nextKeys), map(_ref2 => {
    let [restKeys, asapKeys, nextKeys] = _ref2;
    return {
      asap: asapKeys,
      next: nextKeys,
      rest: restKeys
  ...
  const _targetGroupId = _groups.pipe(debounceTime(0), switchMapTo(_groupIds.pipe(zipWith(_startNextGroup),
  // wait for download to complete
  map(head))), share());

  // Keys of files that are fully fetched
  const _fetchedKeys = _outData.pipe(map(keys), share());

  // Keys in target group that are not yet fully fetched
  // Some of them might be currently downloading
  const _fetchingOrUnfetchedTargetKeys = _targetGroupId.pipe(withLatestFrom(_groups, _shouldPrefetch, _fetchedKeys), map(_ref3 => {
    let [targetGroupId, groups, shouldPrefetch, fetchedKeys] = _ref3;
    return shouldPrefetch || targetGroupId === 'asap' ? difference(groups[targetGroupId], fetchedKeys) : [];
  }), share());
  const _fetchingOrFetchedTargetKeys = _targetGroupId.pipe(withLatestFrom(_groups, _fetchedKeys, _outLoadingKeys), map(_ref4 => {
    let [targetGroupId, groups, fetchedKeys, loadingKeys] = _ref4;
  ...
  const _unfetchedTargetKeys = _fetchingOrUnfetchedTargetKeys.pipe(withLatestFrom(_outLoadingKeys), map(_ref5 => {
    let [fetchingOrUnfetchedTargetKeys, outLoadingKeys] = _ref5;
    return difference(fetchingOrUnfetchedTargetKeys, outLoadingKeys);
  }));
  const _unfetchedUris = _unfetchedTargetKeys.pipe(withLatestFrom(_uriMap), map(_ref6 => {
    let [unfetchedTargetKeys, uriMap] = _ref6;
  ...
  const _cancelKeys = _asapKeys.pipe(debounceTime(0),
  // use `withLatestFrom` instead of `combineLatestWith` (in `derive`) so
  // that it is not recomputed more than needed.
  withLatestFrom(_outLoadingKeys), map(_ref7 => {
    let [asapKeys, outLoadingKeys] = _ref7;
  ...
  _shouldPrefetch.subscribe(should => should && _runChain.next());
  ...
  const cancelAll = reason => _outLoadingKeys.getValue().forEach(key => cancel(key, reason));
  ...
  _cancelKeys.pipe(debounceTime(0)).subscribe(cancelKeys => cancelKeys.forEach(key => cancel(key, 'Cancelled by priority change')));
  _outEvents.pipe(filter(isKeyValue(['type', 'file:start'])), withLatestFrom(_outLoadingKeys)).subscribe(_ref8 => {
    let [{
      key
    }, loadingUris] = _ref8;
    return _outLoadingKeys.next([...loadingUris, key]);
  });
  _outEvents.pipe(filter(_ref9 => {
    let {
      type
    } = _ref9;
    return ['file:cancel', 'file:complete', 'file:error'].includes(type);
  }), withLatestFrom(_outLoadingKeys, _outData)).subscribe(_ref10 => {
    let [{
      data,
      key,
      type
    }, loadingKeys, outData] = _ref10;
  ...
  _outEvents.pipe(filter(isKeyValue(['type', 'group:complete'])), withLatestFrom(_outLoadingKeys)).subscribe(() => _startNextGroup.next());
  ...
  _fetchedKeys.pipe(withLatestFrom(_allKeys, _asapKeys, _shouldPrefetch), skipWhile(_ref11 => {
    let [fetchedUris, allKeys, asapKeys, shouldPrefetch] = _ref11;
    return intersection(shouldPrefetch ? allKeys : asapKeys, fetchedUris).length < (shouldPrefetch ? allKeys : asapKeys).length;
  }), debounceTime(0)).subscribe(() => _outEvents.next({
    type: 'done'
  }));
  return {
    _asapKeys,
...
const makeWebStreamsFetcher = function (myFetch) {
  let transformer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : identity$1;
  return myFetch ? async (key, _ref, cancellers) => {
    let {
      customTransformer,
      url
    } = _ref;
...
/* ../../components/ui/src/io/net/FetchDriver.svelte generated by Svelte v3.59.2 */
...
function instance$5($$self, $$props, $$invalidate) {
  ...
  const reset = downloadFunc => {
    $$subscribe__asapKeys($$invalidate(0, ({
      _asapKeys,
      _nextKeys,
      _outData,
      _outLoadingKeys,
      _shouldPrefetch,
      _uriMap
    } = createFetchManagerStores(downloadFunc)), _asapKeys, $$subscribe__nextKeys($$invalidate(1, _nextKeys)), $$subscribe__outData($$invalidate(2, _outData)), $$subscribe__outLoadingKeys($$invalidate(3, _outLoadingKeys)), $$subscribe__shouldPrefetch($$invalidate(4, _shouldPrefetch)), $$subscribe__uriMap($$invalidate(5, _uriMap))));
  ...
  const writable_props = ['asapKeys', 'nextKeys', 'shouldPrefetch', 'transformer', 'uriMap', 'outData', 'outLoadingKeys'];
...
/* ../../components/time_region_value/src/lib/components/Sidebar.svelte generated by Svelte v3.59.2 */
...
// (63:4) <HyperLink      href={makeURL($_hrefBase, schema.value.id)}      rel='prefetch'      theme={{color: $_theme.colorWhite}}     >
function create_default_slot$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(p, file$3, 67, 5, 1525);
    },
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(63:4) <HyperLink      href={makeURL($_hrefBase, schema.value.id)}      rel='prefetch'      theme={{color: $_theme.colorWhite}}     >",
    ctx
  });
  return block;
}
...
function create_each_block_1$1(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx, dirty) {
      ...
      if (dirty & /*$_hrefBase, $_groups*/36) hyperlink_changes.href = makeURL( /*$_hrefBase*/ctx[5], /*schema*/ctx[16].value.id);
      if (dirty & /*$_theme*/64) hyperlink_changes.theme = {
        color: /*$_theme*/ctx[6].colorWhite
      };
      if (dirty & /*$$scope, $_groups, currentId, scrollableHeight*/524310) {
        hyperlink_changes.$$scope = {
          dirty,
          ctx
        };
      }
...
function create_each_block$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(header, file$3, 60, 3, 1323);
      attr_dev(div, "class", "group svelte-13lnbxn");
      add_location(div, file$3, 59, 2, 1300);
    },
    m: function mount(target, anchor) {
...
function create_fragment$4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(nav, file$3, 54, 0, 1188);
    },
    m: function mount(target, anchor) {
      ...
      nav_resize_listener = add_iframe_resize_listener(nav, /*nav_elementresize_handler*/ctx[8].bind(nav));
      /*nav_binding*/
      ctx[9](nav);
      current = true;
    },
...
function instance$4($$self, $$props, $$invalidate) {
  ...
  function keepOnScreen(node, _ref2) {
    let {
      id,
      currentId,
      scrollableHeight
...
/* ../../components/time_region_value/src/lib/components/Timeline.svelte generated by Svelte v3.59.2 */
...
function create_if_block$2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(svg, "class", "svelte-1diz2k");
...
function create_if_block_4$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(g0, "class", "svelte-1diz2k");
      ...
      attr_dev(g1, "class", "svelte-1diz2k");
...
function create_if_block_1$2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(text_1, "class", "svelte-1diz2k");
...
function create_if_block_3$2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(line, "class", "svelte-1diz2k");
...
function create_each_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(circle, "class", "svelte-1diz2k");
...
function create_each_block(ctx) {
  let text_1;
  let t_value = ( /*$_layout*/ctx[14].doShortenYears ? shortenYear( /*year*/ctx[30]) : /*year*/ctx[30]) + "";
  let t;
...
function create_fragment$3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div, "class", "Timeline svelte-1diz2k");
...
/* ../../components/time_region_value/src/lib/components/ViewSelector.svelte generated by Svelte v3.59.2 */
  ...
  const block = {
    ...
    m: function mount(target, anchor) {
      ...
      if (!mounted) {
        ...
        }, false, false, false, false), listen_dev(div0, "keydown", /*onKeyDown*/ctx[5]('map'), false, false, false, false), listen_dev(div1, "click", function () {
          if (is_function( /*showView*/ctx[2]('barchart'))) /*showView*/ctx[2]('barchart').apply(this, arguments);
        }, false, false, false, false), listen_dev(div1, "keydown", /*onKeyDown*/ctx[5]('barchart'), false, false, false, false)];
        mounted = true;
      }
    },
    p: function update(new_ctx, dirty) {
  ...
  const block = {
    ...
    m: function mount(target, anchor) {
      ...
      if (!mounted) {
        ...
        }, false, false, false, false), listen_dev(div, "keydown", /*onKeyDown*/ctx[5]('trends'), false, false, false, false)];
        mounted = true;
      }
    },
    p: function update(new_ctx, dirty) {
  ...
  const block = {
    ...
    m: function mount(target, anchor) {
      ...
      if (!mounted) {
        ...
        }, false, false, false, false), listen_dev(div, "keydown", /*onKeyDown*/ctx[5]('distribution'), false, false, false, false)];
        mounted = true;
      }
    },
    p: function update(new_ctx, dirty) {
  ...
  const block = {
    ...
    m: function mount(target, anchor) {
      ...
      if (!mounted) {
        ...
        }, false, false, false, false), listen_dev(div0, "keydown", /*onKeyDown*/ctx[5]('info'), false, false, false, false), listen_dev(div1, "click", function () {
          if (is_function( /*showView*/ctx[2]('settings'))) /*showView*/ctx[2]('settings').apply(this, arguments);
        }, false, false, false, false), listen_dev(div1, "keydown", /*onKeyDown*/ctx[5]('settings'), false, false, false, false)];
        mounted = true;
      }
    },
    p: function update(new_ctx, dirty) {
  ...
  const block = {
    ...
    m: function mount(target, anchor) {
      ...
      if (!mounted) {
        ...
        }, false, false, false, false), listen_dev(div, "keydown", /*onKeyDown*/ctx[5]('sidebar'), false, false, false, false)];
        mounted = true;
      }
    },
...
/* ../../components/time_region_value/src/routes/_layout.svelte generated by Svelte v3.59.2 */
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file, 105, 3, 3176);
      attr_dev(section0, "class", "svelte-dclfdu");
      add_location(section0, file, 116, 4, 3392);
      ...
      add_location(div1, file, 111, 3, 3271);
      ...
      add_location(div2, file, 100, 2, 3089);
      ...
      add_location(section1, file, 95, 1, 2970);
    },
    m: function mount(target, anchor) {
      ...
      div1_resize_listener = add_iframe_resize_listener(div1, /*div1_elementresize_handler*/ctx[31].bind(div1));
...
function create_if_block_3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(nav, file, 120, 5, 3466);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, nav, anchor);
      mount_component(timeline, nav, null);
      nav_resize_listener = add_iframe_resize_listener(nav, /*nav_elementresize_handler*/ctx[30].bind(nav));
      current = true;
    },
    p: function update(ctx, dirty) {
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  const writable_props = ['_groups', 'flags', 'hrefBase', 'POIs', 'regionSettings', 'segment', 'shouldPrefetch', 'theme'];
  Object.keys($$props).forEach(key => {
...
/* src/routes/compounds/time_region_value/_layout.svelte generated by Svelte v3.59.2 */
