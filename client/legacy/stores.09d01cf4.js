import { D as _slicedToArray, ab as _toConsumableArray, aj as derived, a1 as writable, ak as readable, al as get_store_value } from './client.83de09e6.js';
import { n as apply, l as pipe, J as collect, am as getLength, an as divide, w as mapWith, a3 as reduceWith, ao as sum, x as getKey, al as is, p as partial, c as __, ap as pluck, ad as flatten, aq as transpose, ar as makeArrayTransformer, q as indexBy, a2 as getPath, as as pickIf, Q as identity, u as keys, m as mapValuesWith, a7 as adapter, at as casus, k as format, a4 as allOf, ac as hasKey, au as not } from './defaultLocale.ed51f02f.js';
import { g as getValue, s as sliceString, i as inclusiveRange, _ as _screen, l as linear, e as joinWithBlank } from './ScreenGauge.8a8b69cb.js';
...
var _POIs = writable();
var setPOIs = function setPOIs(POIs) {
  return _POIs.set(POIs);
};
/* year extent */
...
var _navFlags = writable(defaultFlags);
var setNavFlags = function setNavFlags(flags) {
  return _navFlags.set(flags);
}; // hrefBase

var _hrefBase = writable('');
var setHrefBase = function setHrefBase(href) {
  return _hrefBase.set(href);
};
...
export { _navFlags as A, _POIs as B, keyValueArrayAverage as C, makeGetRefFormatOf as D, _hrefBase as _, _timelineLayout as a, _yearRange$1 as b, shortenYear as c, _isSmallScreen as d, _routes as e, _screenClasses as f, _viewsClasses as g, _isTimelineHidden as h, _timelineWidth as i, _timelineHeight as j, _availableYears as k, _selectedYear as l, setPOIs as m, _views as n, setHrefBase as o, setNavFlags as p, showView as q, _groups as r, setGroups as s, setRoute as t, resetSelection as u, _yearRange as v, resetSelectedYear as w, makeGetIndicatorFormatOf as x, lookup as y, _lookup as z };
