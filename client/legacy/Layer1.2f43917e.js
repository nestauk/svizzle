  ...
  $$self.$$.update = () => {
    ...
    if ($$self.$$.dirty & /*$_bbox, $_projectFn, x1, y1*/122880) {
      ...
      $$invalidate(7, ({
        x: xp1,
        y: yp1
      } = $_projectFn?.([x1, y1])), xp1, ((((($$invalidate(9, yp1), $$invalidate(16, $_bbox)), $$invalidate(15, $_projectFn)), $$invalidate(14, x1)), $$invalidate(13, y1)), $$invalidate(6, wsen)));
    }
    if ($$self.$$.dirty & /*$_bbox, $_projectFn, x2, y2*/104448) {
      ...
      $$invalidate(8, ({
        x: xp2,
        y: yp2
      } = $_projectFn?.([x2, y2])), xp2, ((((($$invalidate(10, yp2), $$invalidate(16, $_bbox)), $$invalidate(15, $_projectFn)), $$invalidate(12, x2)), $$invalidate(11, y2)), $$invalidate(6, wsen)));
    }
