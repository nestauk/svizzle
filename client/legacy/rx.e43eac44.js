import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, I as svg_element, J as claim_svg_element, g as children, b as detach_dev, k as attr_dev, m as add_location, n as insert_hydration_dev, p as noop, bD as readable, by as writable, ct as get_store_value } from './client.c3033a77.js';
...
const rxStreamToSvReadable = rxStream => readable(rxStream.getValue?.(), set => {
  const subscription = rxStream.subscribe(value => set(value));
  return () => subscription.unsubscribe();
});
const rxStreamToSvWritable = rxStream => {
  const store = writable(rxStream.getValue?.(), set => {
