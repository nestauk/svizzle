...
function instance($$self, $$props) {
  ...
  Object.keys($$props).forEach(function (key) {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn("<Download> was created with unknown prop '".concat(key, "'"));
  });
  return [];
}
