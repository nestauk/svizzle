import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, ba as getContext, ak as validate_store, at as component_subscribe, I as svg_element, a as space, t as text, J as claim_svg_element, g as children, b as detach_dev, c as claim_space, j as claim_text, k as attr_dev, m as add_location, n as insert_hydration_dev, o as append_hydration_dev, p as noop } from './client.b153d44c.js';

/* src/routes/compounds/mapbox/components/Layer1.svelte generated by Svelte v3.58.0 */
...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach(key => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn("<Layer1> was created with unknown prop '".concat(key, "'"));
  });
  $$self.$$set = $$props => {
  ...
  $$self.$$.update = () => {
    ...
    if ($$self.$$.dirty & /*$_bbox, $_projectFn, x1, y1*/122880) {
      ...
      $$invalidate(7, ({
        x: xp1,
        y: yp1
      } = (_$_projectFn = $_projectFn) === null || _$_projectFn === void 0 ? void 0 : _$_projectFn([x1, y1])), xp1, ((((($$invalidate(9, yp1), $$invalidate(16, $_bbox)), $$invalidate(15, $_projectFn)), $$invalidate(14, x1)), $$invalidate(13, y1)), $$invalidate(6, wsen)));
    }
    if ($$self.$$.dirty & /*$_bbox, $_projectFn, x2, y2*/104448) {
      ...
      $$invalidate(8, ({
        x: xp2,
        y: yp2
      } = (_$_projectFn2 = $_projectFn) === null || _$_projectFn2 === void 0 ? void 0 : _$_projectFn2([x2, y2])), xp2, ((((($$invalidate(10, yp2), $$invalidate(16, $_bbox)), $$invalidate(15, $_projectFn)), $$invalidate(12, x2)), $$invalidate(11, y2)), $$invalidate(6, wsen)));
    }
  ...
  return [height, width, y, x, _bbox, _projectFn, wsen, xp1, xp2, yp1, yp2, y2, x2, y1, x1, $_projectFn, $_bbox];
}
