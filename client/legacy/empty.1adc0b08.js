import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, D as create_component, f as claim_element, g as children, E as claim_component, b as detach_dev, k as attr_dev, m as add_location, n as insert_hydration_dev, F as mount_component, p as noop, u as transition_in, B as transition_out, G as destroy_component } from './client.fb549d0a.js';
...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach(key => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn("<Empty> was created with unknown prop '".concat(key, "'"));
  });
  $$self.$capture_state = () => ({
    Mapbox,
    accessToken,
