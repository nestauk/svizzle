...
const _ = [],
  w = e => {
    ...
    })(`Unable to find the ${e}. No data will be persisted.`);
  };
function O(e) {
  L(e);
}
...
function I() {
  ...
  return k("localStorage") ? C(window.localStorage, e) : (w("window.localStorage"), U());
}
function V() {
  let e = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !1;
  return k("sessionStorage") ? C(window.sessionStorage, e) : (w("window.sessionStorage"), U());
}
function R(e) {
...
function P() {
  if ("object" != typeof indexedDB || !k("indexedDB")) return w("IndexedDB"), T();
  const {
      removeListener: e,
      callListeners: t,
      addListener: n
...
const z = {};
function G(e) {
  if (!Object.keys(z).includes(e)) switch (e) {
    case "cookie":
      z[e] = R();
      break;
    case "local":
...
function q(e, t) {
  return j(e, G("cookie"), t);
}
function F(e, t) {
  return j(e, G("session"), t);
}
function J(e, t) {
  return j(e, G("local"), t);
}
function X(e, t, n) {
  return J(Y(t, n), e);
}
...
var W,
  ...
  oe = function (e, t) {
    ...
    return t &= 31, n > 0 && t && (e[n - 1] = re(t, e[n - 1] & 2147483648 >> t - 1, 1)), e;
  },
  ie = function (e) {
    var t,
      n,
...
ae.cipher.aes = function (e) {
  ...
  var t,
    ...
    s = e.length,
    u = 1;
  if (4 !== s && 6 !== s && 8 !== s) throw new ae.exception.invalid("invalid aes key size");
  ...
  _crypt: function (e, t) {
    if (4 !== e.length) throw new ae.exception.invalid("invalid aes block size");
    var n,
      r,
      o,
      i,
  ...
  bitSlice: function (e, t, n) {
    return e = ae.bitArray._shiftRight(e.slice(t / 32), 32 - (31 & t)).slice(1), void 0 === n ? e : ae.bitArray.clamp(e, n - t);
  },
  ...
  concat: function (e, t) {
    ...
    var n = e[e.length - 1],
      r = ae.bitArray.getPartial(n);
    return 32 === r ? e.concat(t) : ae.bitArray._shiftRight(t, r, 0 | n, e.slice(0, e.length - 1));
  },
  bitLength: function (e) {
    var t,
      n = e.length;
    return 0 === n ? 0 : (t = e[n - 1], 32 * (n - 1) + ae.bitArray.getPartial(t));
  },
  clamp: function (e, t) {
    if (32 * e.length < t) return e;
    var n = (e = e.slice(0, Math.ceil(t / 32))).length;
    return t &= 31, n > 0 && t && (e[n - 1] = ae.bitArray.partial(t, e[n - 1] & 2147483648 >> t - 1, 1)), e;
  },
  ...
  equal: function (e, t) {
    if (ae.bitArray.bitLength(e) !== ae.bitArray.bitLength(t)) return !1;
    var n,
      r = 0;
  ...
  _shiftRight: function (e, t, n, r) {
    ...
    return i = e.length ? e[e.length - 1] : 0, c = ae.bitArray.getPartial(i), r.push(ae.bitArray.partial(t + c & 31, t + c > 32 ? n : r.pop(), 1)), r;
  },
  _xor4: function (e, t) {
  ...
  toBits: function (e) {
    ...
    return 3 & t && n.push(ae.bitArray.partial(8 * (3 & t), r)), n;
  }
}, ae.codec.base64 = {
  ...
  fromBits: function (e, t, n) {
    var r,
      o = "",
      i = 0,
      c = ae.codec.base64._chars,
      a = 0,
      s = ae.bitArray.bitLength(e);
  ...
  toBits: function (e, t) {
    ...
    for (t && (c = c.substr(0, 62) + "-_"), n = 0; n < e.length; n++) {
      if ((r = c.indexOf(e.charAt(n))) < 0) throw new ae.exception.invalid("this isn't base64!");
      i > 26 ? (i -= 26, o.push(a ^ r >>> i), a = r << 32 - i) : a ^= r << 32 - (i += 6);
    }
    return 56 & i && o.push(ae.bitArray.partial(56 & i, a, 1)), o;
  }
}, ae.codec.base64url = {
  fromBits: function (e) {
    return ae.codec.base64.fromBits(e, 1, 1);
  },
  toBits: function (e) {
    return ae.codec.base64.toBits(e, 1);
  }
}, ae.mode.gcm = {
  name: "gcm",
  encrypt: function (e, t, n, r, o) {
    var i,
      c = t.slice(0),
      a = ae.bitArray;
    return o = o || 128, r = r || [], i = ae.mode.gcm._ctrMode(!0, e, c, r, n, o), a.concat(i.data, i.tag);
  },
  decrypt: function (e, t, n, r, o) {
    var i,
      ...
      s = ae.bitArray,
      u = s.bitLength(a);
    if (r = r || [], (o = o || 128) <= u ? (c = s.bitSlice(a, u - o), a = s.bitSlice(a, 0, u - o)) : (c = a, a = []), i = ae.mode.gcm._ctrMode(!1, e, a, r, n, o), !s.equal(i.tag, c)) throw new ae.exception.corrupt("gcm: tag doesn't match");
    return i.data;
  },
  ...
  _ghash: function (e, t, n) {
    var r,
      o,
      i = n.length;
    for (r = t.slice(0), o = 0; o < i; o += 4) r[0] ^= 4294967295 & n[o], r[1] ^= 4294967295 & n[o + 1], r[2] ^= 4294967295 & n[o + 2], r[3] ^= 4294967295 & n[o + 3], r = ae.mode.gcm._galoisMultiply(r, e);
    return r;
  },
  _ctrMode: function (e, t, n, r, o, i) {
    var c,
      ...
      m,
      b = ae.bitArray;
    for (p = n.length, g = b.bitLength(n), y = b.bitLength(r), m = b.bitLength(o), c = t.encrypt([0, 0, 0, 0]), 96 === m ? (a = o.slice(0), a = b.concat(a, [1])) : (a = ae.mode.gcm._ghash(c, [0, 0, 0, 0], o), a = ae.mode.gcm._ghash(c, a, [0, 0, Math.floor(m / 4294967296), 4294967295 & m])), s = ae.mode.gcm._ghash(c, [0, 0, 0, 0], r), f = a.slice(0), h = s.slice(0), e || (h = ae.mode.gcm._ghash(c, s, n)), l = 0; l < p; l += 4) f[3]++, u = t.encrypt(f), n[l] ^= u[0], n[l + 1] ^= u[1], n[l + 2] ^= u[2], n[l + 3] ^= u[3];
    return n = b.clamp(n, g), e && (h = ae.mode.gcm._ghash(c, s, n)), d = [Math.floor(y / 4294967296), 4294967295 & y, Math.floor(g / 4294967296), 4294967295 & g], h = ae.mode.gcm._ghash(c, h, d), u = t.encrypt(a), h[0] ^= u[0], h[1] ^= u[1], h[2] ^= u[2], h[3] ^= u[3], {
...
class ue {
  constructor(e) {
    this.cipher = new ae.cipher.aes(ce(e));
  }
  encrypt(e, t) {
    t || (t = "sps");
    const n = ae.codec.utf8String.toBits(t);
    return ne(ae.mode.gcm.encrypt(this.cipher, ae.codec.utf8String.toBits(e), n, [], 256)) + ":" + ne(n);
  }
  decrypt(e) {
    return ae.codec.utf8String.fromBits(ae.mode.gcm.decrypt(this.cipher, ce(e.split(":")[0]), ce(e.split(":")[1])));
  }
  hash(e) {
...
export { ue as GCMEncryption, O as addSerializableClass, Q as cookieWritable, B as createChromeStorage, R as createCookieStorage, le as createEncryptedStorage, fe as createEncryptionStorage, P as createIndexedDBStorage, I as createLocalStorage, U as createNoopStorage, V as createSessionStorage, b as disableWarnings, X as localWritable, se as noEncryptionBehavior, j as persist, J as persistBrowserLocal, F as persistBrowserSession, q as persistCookie, K as sessionWritable, E as setSerialization, H as writable };
