import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, r as create_slot, v as validate_slots, ba as getContext, ak as validate_store, at as component_subscribe, e as element, f as claim_element, g as children, b as detach_dev, m as add_location, n as insert_hydration_dev, av as action_destroyer, y as update_slot_base, z as get_all_dirty_from_scope, A as get_slot_changes, u as transition_in, B as transition_out } from './client.b153d44c.js';
import { C as CustomControl$1 } from './Mapbox.72fab2db.js';

/* ../../components/mapbox/src/CustomControl.svelte generated by Svelte v3.58.0 */
...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach(key => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn("<CustomControl> was created with unknown prop '".concat(key, "'"));
  });
  $$self.$$set = $$props => {
