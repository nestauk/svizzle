...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      if (iframe.src !== (iframe_src_value = "jsDocBuild/")) attr_dev(iframe, "src", iframe_src_value);
