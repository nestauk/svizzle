...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$.update = function () {
    ...
    /*glyph*/
    2) {
      $$invalidate(1, glyph = glyph || Loader);
    }
...
export { LoadingView as L, Loader as a };
