import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, I as svg_element, J as claim_svg_element, g as children, b as detach_dev, k as attr_dev, m as add_location, n as insert_hydration_dev, p as noop, r as create_slot, K as makeStyleVars, L as Icon, e as element, a as space, f as claim_element, c as claim_space, H as toggle_class, o as append_hydration_dev, M as listen_dev, y as update_slot_base, z as get_all_dirty_from_scope, A as get_slot_changes, u as transition_in, w as group_outros, B as transition_out, x as check_outros, D as create_component, E as claim_component, F as mount_component, G as destroy_component } from './client.c3033a77.js';
...
/* ../../components/ui/src/HyperLink.svelte generated by Svelte v3.59.2 */
const file = "../../components/ui/src/HyperLink.svelte";
...
function instance($$self, $$props, $$invalidate) {
  ...
  validate_slots('HyperLink', slots, ['default']);
  const {
    defaultStrokeWidth
  } = Icon;
  const defaultTheme = {
  ...
  const writable_props = ['ariaDescribedBy', 'ariaLabel', 'download', 'href', 'hreflang', 'iconSize', 'isBold', 'isUnderlined', 'rel', 'showIcon', 'target', 'theme', 'type'];
  Object.keys($$props).forEach(key => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<HyperLink> was created with unknown prop '${key}'`);
  });
  $$self.$$set = $$props => {
...
class HyperLink extends SvelteComponentDev {
  constructor(options) {
    super(options);
  ...
  get ariaDescribedBy() {
    throw new Error("<HyperLink>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  set ariaDescribedBy(value) {
    throw new Error("<HyperLink>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
  get ariaLabel() {
    throw new Error("<HyperLink>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
...
var HyperLink$1 = HyperLink;

export { ExternalLink$1 as E, HyperLink$1 as H, defaultRel as d };
