import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, q as validate_each_argument, r as create_slot, v as validate_slots, e as element, a as space, f as claim_element, g as children, b as detach_dev, c as claim_space, k as attr_dev, m as add_location, n as insert_hydration_dev, o as append_hydration_dev, u as transition_in, w as group_outros, x as check_outros, y as update_slot_base, z as get_all_dirty_from_scope, A as get_slot_changes, B as transition_out, C as destroy_each, D as create_component, E as claim_component, F as mount_component, G as destroy_component, t as text, j as claim_text, H as toggle_class } from './client.c3033a77.js';
import { H as HyperLink } from './HyperLink.47b34ea4.js';

/* src/routes/compounds/viewports/_layout.svelte generated by Svelte v3.59.2 */
const file = "src/routes/compounds/viewports/_layout.svelte";
...
// (12:3) <HyperLink     href='compounds/viewports/{example}'     rel='prefetch'    >
function create_default_slot(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(p, "class", "svelte-irc0qz");
      toggle_class(p, "selected", /*example*/ctx[4] === /*segment*/ctx[0]);
      add_location(p, file, 15, 4, 280);
    },
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(12:3) <HyperLink     href='compounds/viewports/{example}'     rel='prefetch'    >",
    ctx
  });
  return block;
}
...
function create_each_block(ctx) {
  ...
  hyperlink = new HyperLink({
    props: {
      href: "compounds/viewports/" + /*example*/ctx[4],
      rel: "prefetch",
      $$slots: {
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(nav, "class", "svelte-irc0qz");
      add_location(nav, file, 9, 1, 161);
      attr_dev(main, "class", "svelte-irc0qz");
      add_location(main, file, 21, 1, 382);
      attr_dev(section, "class", "svelte-irc0qz");
      add_location(section, file, 8, 0, 150);
    },
    m: function mount(target, anchor) {
