import { ac as partial, ad as __, ap as _toConsumableArray, cD as apply, a7 as pipe, ar as collect, cE as getLength, A as _slicedToArray, au as reduceWith, cF as sum, cG as pluck, cg as flatten, cH as indexBy, as as getPath, cI as transpose, cJ as derived, br as writable, aM as _screen, ca as adapter, cK as casus, cL as isNil, c7 as allOf, cs as isKeyValue, cf as hasKey, c5 as not, ck as identity, cM as getTruthyValuesKeys, cN as joinWithBlank, a8 as mapValuesWith, bx as readable } from './client.a726f8ff.js';
import { s as sliceString, f as arraySumWith, g as getValue, i as inclusiveRange, l as linear } from './linear.afac3673.js';
import { m as makeArrayTransformer, b as format } from './defaultLocale.8c8e60d1.js';
 ...
 * @since 0.11.0
 */
pipe([collect([arraySum, getLength]), function (_ref3) {
 ...
 * @since 0.11.0
 */
var keyValueArrayAverage = pipe([collect([arraySumWith(getValue), getLength]), function (_ref5) {
...
var makeClasses = pipe([getTruthyValuesKeys, joinWithBlank]); // TBD to /dom?
...
var _viewsClasses = derived(_views, makeClasses);
