import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, D as create_component, f as claim_element, g as children, E as claim_component, b as detach_dev, k as attr_dev, m as add_location, n as insert_hydration_dev, F as mount_component, u as transition_in, B as transition_out, G as destroy_component, t as text, j as claim_text, o as append_hydration_dev, M as listen_dev, p as noop } from './client.b153d44c.js';
import { C as CustomControl } from './CustomControl.2762d753.js';
import { M as Mapbox } from './Mapbox.72fab2db.js';

/* src/routes/compounds/mapbox/custom_controls.svelte generated by Svelte v3.58.0 */
const file = "src/routes/compounds/mapbox/custom_controls.svelte";

// (24:2) <CustomControl position='top-left'>
function create_default_slot_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(button, "class", "svelte-1cxu3cj");
      add_location(button, file, 24, 3, 564);
    },
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(24:2) <CustomControl position='top-left'>",
    ctx
  });
  return block;
}

// (17:4) <Mapbox   {accessToken}   {bounds}         {styleURL}   withScaleControl={true}         withZoomControl={true}     >
function create_default_slot(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(17:4) <Mapbox   {accessToken}   {bounds}         {styleURL}   withScaleControl={true}         withZoomControl={true}     >",
    ctx
  });
  return block;
}
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div, "class", "map-container svelte-1cxu3cj");
      add_location(div, file, 15, 0, 374);
    },
    m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach(key => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn("<Custom_controls> was created with unknown prop '".concat(key, "'"));
  });
  $$self.$capture_state = () => ({
    Mapbox,
    CustomControl,
