import { E as _slicedToArray, _ as _inherits, a as _getPrototypeOf, b as _possibleConstructorReturn, c as _classCallCheck, i as init, s as safe_not_equal, d as _assertThisInitialized, e as dispatch_dev, x as _createClass, S as SvelteComponentDev, y as validate_each_argument, ak as validate_store, al as component_subscribe, w as validate_slots, ax as subscribe, bx as onMount, g as element, t as text, f as space, k as claim_element, l as children, m as claim_text, h as detach_dev, j as claim_space, n as attr_dev, p as add_location, r as insert_hydration_dev, u as append_hydration_dev, a8 as set_data_dev, A as transition_in, M as group_outros, B as transition_out, C as check_outros, D as destroy_each, ah as add_render_callback, ai as add_resize_listener, v as noop, aO as binding_callbacks, I as create_component, J as claim_component, K as mount_component, L as destroy_component, N as toggle_class, by as action_destroyer, av as is_function, aH as isServerSide, bg as isNotNil, aM as _, ar as last, bz as findIndex, bA as is, O as svg_element, ab as empty, P as claim_svg_element, b1 as when, aZ as always, Q as Icon, a1 as mapValuesWith, a9 as listen_dev, aw as run_all, aG as ScreenSensor, z as create_slot, F as update_slot_base, G as get_all_dirty_from_scope, H as get_slot_changes, q as query_selector_all } from './client.50a99e71.js';
import { L as LoadingView } from './LoadingView.ff2518d1.js';
import { L as Link } from './linear.0c4bf1cb.js';
import { _ as _hrefBase, s as setGroups, a as _timelineLayout, b as _yearRange, c as shortenYear, d as _routes, e as _isSmallScreen, f as _screenClasses, g as _viewsClasses, h as _isTimelineHidden, i as _timelineWidth, j as _timelineHeight, k as _selectedYear, l as _navFlags, m as _views, n as showView, o as _groups } from './stores.8e11225e.js';
import { _ as _theme, a as _style, b as _availableYears, c as _regionSettings, d as customizeTheme } from './indicator.6db11939.js';
import { m as makeURL, f as flags, h as hrefBase, r as regionSettings } from './_config.337661bb.js';
import { L as List, A as Activity, B as BarChart, C as Clock, M as MapPin } from './MapPin.a08fcb29.js';
import { I as Info } from './Info.9508c99c.js';
import { S as Settings } from './Settings.99ce71b8.js';
import { _ as _POIs } from './POIs.f7330722.js';
...
function create_if_block_4(ctx) {
  ...
  function select_block_type(ctx, dirty) {
    if (
    /*hrefPrev*/
    ctx[16]) return create_if_block_6;
  ...
  function select_block_type_1(ctx, dirty) {
    if (
    /*hrefNext*/
    ctx[15]) return create_if_block_5;
  ...
  var block = {
    ...
    p: function update(ctx, dirty) {
      ...
      if (dirty[0] &
      /*prevX, buttonY*/
      4198400 && g0_transform_value !== (g0_transform_value = "translate(" +
      /*prevX*/
      ctx[22] + "," +
      /*buttonY*/
      ctx[12] + ")")) {
      ...
      if (dirty[0] &
      /*nextX, buttonY*/
      6144 && g1_transform_value !== (g1_transform_value = "translate(" +
      /*nextX*/
      ctx[11] + "," +
      /*buttonY*/
      ctx[12] + ")")) {
...
function create_if_block_6(ctx) {
  ...
  var block = {
    ...
    p: function update(ctx, dirty) {
      ...
      if (dirty[0] &
      /*prevYear*/
      256 && a_aria_label_value !== (a_aria_label_value = "Show the previous year (" +
      /*prevYear*/
      ctx[8] + ")")) {
...
function create_if_block_5(ctx) {
  ...
  var block = {
    ...
    p: function update(ctx, dirty) {
      ...
      if (dirty[0] &
      /*nextYear*/
      64 && a_aria_label_value !== (a_aria_label_value = "Show the next year (" +
      /*nextYear*/
      ctx[6] + ")")) {
        attr_dev(a, "aria-label", a_aria_label_value);
      }
...
function create_each_block_1(ctx) {
  ...
  var block = {
    ...
    p: function update(ctx, dirty) {
      ...
      16385 && circle_cx_value !== (circle_cx_value =
      /*$_layout*/
      ctx[14].scaleX(
      /*year*/
      ctx[30]))) {
      ...
      if (dirty[0] &
      /*$_layout*/
      16384 && circle_r_value !== (circle_r_value =
      /*$_layout*/
      ctx[14].radius)) {
        attr_dev(circle, "r", circle_r_value);
      }
      ...
      8197 && a_href_value !== (a_href_value = makeURL(
      /*$_hrefBase*/
      ctx[13],
      /*indicatorId*/
      ctx[2],
...
function create_each_block(ctx) {
  ...
  var t_value = (
  /*$_layout*/
  ctx[14].doShortenYears ? shortenYear(
  /*year*/
  ctx[30]) :
  /*year*/
  ctx[30]) + "";
  ...
  var block = {
    ...
    p: function update(ctx, dirty) {
      ...
      if (dirty[0] &
      /*$_layout*/
      16384 && text_1_font_size_value !== (text_1_font_size_value =
      /*$_layout*/
      ctx[14].fontSize)) {
        attr_dev(text_1, "font-size", text_1_font_size_value);
      }
      ...
      if (dirty[0] &
      /*$_layout, $_yearRange*/
      16793600 && text_1_x_value !== (text_1_x_value =
      /*$_layout*/
      ctx[14].scaleX(
      /*year*/
      ctx[30]))) {
...
function create_fragment$3(ctx) {
  ...
  ctx[1] &&
  /*$_layout*/
  ctx[14] || isServerSide) && create_if_block$2(ctx);
  var block = {
    c: function create() {
      div = element("div");
...
var file$1 = "../../components/time_region_value/src/routes/_layout.svelte"; // (68:0) {#if $_screenClasses || isServerSide}
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  var $_groups,
      ...
      $$subscribe__groups = function $$subscribe__groups() {
    return $$unsubscribe__groups(), $$unsubscribe__groups = subscribe(_groups, function ($$value) {
      return $$invalidate(20, $_groups = $$value);
    }), _groups;
  };
  ...
  component_subscribe($$self, _routes, function ($$value) {
    return $$invalidate(19, $_routes = $$value);
  });
  ...
  return [_groups, segment, $_isSmallScreen, routeIdYear, routeId, $_screenClasses, $_style, $_viewsClasses, $_isTimelineHidden, $_timelineWidth, $_timelineHeight, $_availableYears, $_selectedYear, $_theme, flags, hrefBase, POIs, regionSettings, theme, $_routes, $_groups, $$scope, slots, nav_elementresize_handler, div1_elementresize_handler];
}
...
var file = "src/routes/compounds/time_region_value/_layout.svelte"; // (17:2) <Link    href='/svizzle/compounds/time_region_value'    rel='prefetch'   >
