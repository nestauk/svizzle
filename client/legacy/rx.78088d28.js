...
var MapPin = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  return _createClass(MapPin);
}(SvelteComponentDev);
var MapPin$1 = MapPin;

var rxStreamToSvReadable = function rxStreamToSvReadable(rxStream) {
  var _rxStream$getValue;
  return readable((_rxStream$getValue = rxStream.getValue) === null || _rxStream$getValue === void 0 ? void 0 : _rxStream$getValue.call(rxStream), function (set) {
    var subscription = rxStream.subscribe(function (value) {
      return set(value);
    });
    return function () {
...
var rxStreamToSvWritable = function rxStreamToSvWritable(rxStream) {
  var _rxStream$getValue2;
  var store = writable((_rxStream$getValue2 = rxStream.getValue) === null || _rxStream$getValue2 === void 0 ? void 0 : _rxStream$getValue2.call(rxStream), function (set) {
    var subscription = rxStream.subscribe(function (value) {
      return value !== get_store_value(store) && set(value);
    });
    return function () {
      return subscription.unsubscribe();
    };
