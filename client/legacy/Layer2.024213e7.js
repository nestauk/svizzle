  ...
  $$self.$$.update = () => {
    ...
    if ($$self.$$.dirty & /*$_bbox, $_projectFn, x1, y1*/983040) {
      ...
      $$invalidate(0, ({
        x: xp1,
        y: yp1
      } = $_projectFn?.([x1, y1])), xp1, ((((($$invalidate(8, yp1), $$invalidate(19, $_bbox)), $$invalidate(18, $_projectFn)), $$invalidate(17, x1)), $$invalidate(16, y1)), $$invalidate(7, wsen)));
    }
    if ($$self.$$.dirty & /*$_bbox, $_projectFn, x2, y2*/835584) {
      ...
      $$invalidate(1, ({
        x: xp2,
        y: yp2
      } = $_projectFn?.([x2, y2])), xp2, ((((($$invalidate(9, yp2), $$invalidate(19, $_bbox)), $$invalidate(18, $_projectFn)), $$invalidate(15, x2)), $$invalidate(14, y2)), $$invalidate(7, wsen)));
    }
