import { cj as allOf, ck as isGTE, cl as isLTE, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, I as svg_element, J as claim_svg_element, g as children, b as detach_dev, k as attr_dev, m as add_location, n as insert_hydration_dev, p as noop, r as create_slot, K as makeStyleVars, e as element, f as claim_element, o as append_hydration_dev, y as update_slot_base, z as get_all_dirty_from_scope, A as get_slot_changes, u as transition_in, B as transition_out, L as Icon, w as group_outros, x as check_outros, a as space, c as claim_space, t as text, j as claim_text, ah as set_data_dev, D as create_component, E as claim_component, F as mount_component, G as destroy_component, q as validate_each_argument, N as createEventDispatcher, C as destroy_each, H as toggle_class, M as listen_dev, aV as is_function, az as run_all, bK as sort, cm as adapter, Y as map, W as pipe, bV as reduce, aR as isNotNil, ao as isIterableNotEmpty, cn as every, co as hasKey, _ as getKey, U as mapWith, cp as flatten, as as getPath, a6 as collect, cq as findIndexWhere, cr as findLastIndexWhere, cs as slice, bL as uniques, X as sortWith, an as filterWith, bE as identity, ax as validate_store, aJ as component_subscribe, by as writable, bG as concat, bH as mergeObj, a9 as appendTo, a8 as last, bJ as pullFrom, aE as empty, aT as add_render_callback, aU as add_iframe_resize_listener, aB as bubble } from './client.c3033a77.js';
import { d as defaultRel } from './HyperLink.47b34ea4.js';
import { a as arrayMaxWith, b as arrayMinWith, l as linear } from './linear.1b91202b.js';
import { e as extent } from './quantize.80df30b4.js';
import { i as inclusiveRange, h as getValues, j as getFirstAndLast } from './defaultLocale.cc2e245b.js';
 ...
 * @since 0.1.0
 */
const makeIsWithinRange = range => allOf([isGTE(range[0]), isLTE(range[1])]);
...
function instance$5($$self, $$props, $$invalidate) {
  ...
  const writable_props = ['alignHorizontally', 'backgroundColor', 'color', 'fontSize', 'padding', 'textAlign'];
  Object.keys($$props).forEach(key => {
...
function instance$4($$self, $$props, $$invalidate) {
  ...
  const writable_props = ['download', 'glyph', 'href', 'hreflang', 'iconSize', 'rel', 'target', 'text', 'theme', 'type'];
  Object.keys($$props).forEach(key => {
  ...
  const block = {
    ...
    m: function mount(target, anchor) {
      ...
      if (!mounted) {
        ...
        }, false, false, false, false), listen_dev(span, "keydown", function () {
...
const exactAmountBins = _ref => {
  ...
  const activeRange = maxExtent ? sort(maxExtent) : extent(array, accessor);
  ...
  // TODO svizzle/utils
  const findRangeIndex = adapter(map(ranges, (range, index) => {
    const predicate = pipe([accessor, allOf([makeIsWithinRange(activeRange), makeIsWithinRange(range)])]);
 ...
 * @since 0.1.0
 */
const areValidBins = allOf([isIterableNotEmpty, every(allOf([hasKey('range'), pipe([getKey('range'), isNotNil])]))]);
 ...
 * @since 0.1.0
 */
const getBinsItems = pipe([mapWith(getValues), flatten]);
 ...
 * @since 0.1.0
 */
const getBinsTicks = pipe([mapWith(getKey('range')), flatten, uniques, sortWith([])]);
 ...
 * @since 0.1.0
 */
const getNonEmptyBinsTicks = pipe([filterWith(getValuesLength), getBinsTicks]);
...
function create_else_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(rect, file$1, 356, 5, 8303);
      attr_dev(g0, "class", "bars");
      attr_dev(g0, "role", "none");
      add_location(g0, file$1, 351, 4, 8222);
      attr_dev(g1, "transform", g1_transform_value = "translate(" + /*origin*/ctx[15].x + "," + /*origin*/ctx[15].y + ")");
      add_location(g1, file$1, 347, 3, 8089);
    },
    m: function mount(target, anchor) {
...
function create_if_block_6(ctx) {
  ...
  const block = {
    ...
    m: function mount(target, anchor) {
      insert_hydration_dev(target, rect, anchor);
      if (!mounted) {
        dispose = [listen_dev(rect, "click", /*resetSelection*/ctx[23], false, false, false, false), listen_dev(rect, "keydown", /*onKeyDown*/ctx[24], false, false, false, false)];
        mounted = true;
      }
    },
    p: function update(ctx, dirty) {
...
function create_if_block_5(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(rect, file$1, 383, 8, 8879);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, rect, anchor);
      if (!mounted) {
        dispose = [listen_dev(rect, "mousedown", /*onMousedown*/ctx[18], false, false, false, false), listen_dev(rect, "mouseover", /*onMouseenter*/ctx[17]( /*index*/ctx[60]), false, false, false, false), listen_dev(rect, "mouseout", /*onMouseleave*/ctx[21]( /*index*/ctx[60]), false, false, false, false), listen_dev(rect, "mousemove", function () {
        ...
        }, false, false, false, false), listen_dev(rect, "mouseup", /*onMouseup*/ctx[20]( /*index*/ctx[60]), false, false, false, false)];
        mounted = true;
      }
    },
    p: function update(new_ctx, dirty) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(381:7) {#if flags.isInteractive}",
    ctx
  });
  return block;
}

// (363:5) {#each bars as {       barWidth,       barHeight,       fill,       selected,       x,       y      }
function create_each_block_1(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "each",
    source: "(363:5) {#each bars as {       barWidth,       barHeight,       fill,       selected,       x,       y      }",
    ctx
  });
  return block;
}

// (401:4) {#if flags.showTicks}
function create_if_block_4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(g, file$1, 401, 5, 9322);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, g, anchor);
      for (let i = 0; i < each_blocks.length; i += 1) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(401:4) {#if flags.showTicks}",
    ctx
  });
  return block;
}

// (407:6) {#each ticks as {label, x, y}}
function create_each_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(text_1, file$1, 407, 7, 9469);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, text_1, anchor);
      append_hydration_dev(text_1, t);
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "each",
    source: "(407:6) {#each ticks as {label, x, y}}",
    ctx
  });
  return block;
}
...
function create_if_block_2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(g, file$1, 414, 5, 9578);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, g, anchor);
      if_block.m(g, null);
...
function create_else_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(line, file$1, 423, 7, 9733);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, line, anchor);
    },
...
function create_if_block_3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(line, "class", "svelte-19g5ym1");
      add_location(line, file$1, 418, 7, 9644);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, line, anchor);
    },
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(418:6) {#if flags.isVertical}",
    ctx
  });
  return block;
}
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  const writable_props = ['height', 'width', 'bins', 'flags', 'geometry', 'message', 'selectedBins', 'theme', 'ticksFormatFn'];
  Object.keys($$props).forEach(key => {
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(h2, "class", "svelte-giosd4");
      add_location(h2, file, 34, 3, 745);
      attr_dev(header, "class", "svelte-giosd4");
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(svg, "class", "svelte-giosd4");
      add_location(svg, file, 42, 3, 894);
      attr_dev(main, "class", "svelte-giosd4");
      ...
      attr_dev(div, "class", "ColorBinsDiv svelte-giosd4");
      attr_dev(div, "style", /*style*/ctx[10]);
...
function instance($$self, $$props, $$invalidate) {
  ...
  let height = 0;
  let width = 0;
  const writable_props = ['headerHeight', 'padding', 'title', 'bins', 'flags', 'geometry', 'message', 'selectedBins', 'theme', 'ticksFormatFn'];
  Object.keys($$props).forEach(key => {
