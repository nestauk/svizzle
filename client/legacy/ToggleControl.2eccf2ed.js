import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, K as makeStyleVars, e as element, a as space, t as text, f as claim_element, g as children, c as claim_space, j as claim_text, b as detach_dev, k as attr_dev, m as add_location, n as insert_hydration_dev, o as append_hydration_dev, M as listen_dev, a4 as set_data_dev, p as noop } from './client.b153d44c.js';

/* src/routes/compounds/mapbox/components/ToggleControl.svelte generated by Svelte v3.58.0 */
...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach(key => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn("<ToggleControl> was created with unknown prop '".concat(key, "'"));
  });
