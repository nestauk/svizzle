import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, D as create_component, f as claim_element, g as children, E as claim_component, b as detach_dev, k as attr_dev, m as add_location, n as insert_hydration_dev, F as mount_component, u as transition_in, B as transition_out, G as destroy_component, aG as binding_callbacks, cf as bind, a as space, aE as empty, c as claim_space, w as group_outros, x as check_outros, cg as add_flush_callback, t as text, j as claim_text, o as append_hydration_dev, M as listen_dev, p as noop } from './client.7dada05b.js';
...
function create_default_slot_5(ctx) {
	...
	let togglecontrol_props = { title: "Show custom controls" };
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(29:2) <CustomControl position='top-left'>",
		ctx
	});
...
// (35:2) {#if isCustomControlVisible}
function create_if_block_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(35:2) {#if isCustomControlVisible}",
		ctx
	});
...
// (36:3) <CustomControl position='top-left'>
function create_default_slot_4(ctx) {
	...
	let togglecontrol0_props = { title: "Show first custom layer" };
	...
	let togglecontrol1_props = { title: "Show second custom layer" };
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(36:3) <CustomControl position='top-left'>",
		ctx
	});
...
// (48:2) <CustomControl position='bottom-left'>
function create_default_slot_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file, 48, 3, 1287);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(48:2) <CustomControl position='bottom-left'>",
		ctx
	});
...
function create_if_block_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(54:2) {#if isCustomLayer1Visible}",
		ctx
	});
...
// (55:3) <SvgLayer     isInteractive={false}     order={1}    >
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(55:3) <SvgLayer     isInteractive={false}     order={1}    >",
		ctx
	});
...
function create_if_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(63:2) {#if isCustomLayer2Visible}",
		ctx
	});
...
// (64:3) <SvgLayer     isInteractive={false}     order={2}    >
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(64:3) <SvgLayer     isInteractive={false}     order={2}    >",
		ctx
	});
...
// (22:1) <Mapbox   {accessToken}   {bounds}   {style}   withScaleControl={true}   withZoomControl={true}  >
function create_default_slot(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*$$scope, isCustomControlVisible*/ 257) {
				customcontrol0_changes.$$scope = { dirty, ctx };
			}
			...
			if (dirty & /*$$scope*/ 256) {
				customcontrol1_changes.$$scope = { dirty, ctx };
			}
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(22:1) <Mapbox   {accessToken}   {bounds}   {style}   withScaleControl={true}   withZoomControl={true}  >",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 20, 0, 649);
		},
		m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	return [
		...
		bounds,
		zoomToEngland,
		togglecontrol_checked_binding,
		togglecontrol0_checked_binding,
		togglecontrol1_checked_binding
	];
}
