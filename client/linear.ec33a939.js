import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, I as svg_element, J as claim_svg_element, g as children, b as detach_dev, j as attr_dev, l as add_location, m as insert_hydration_dev, o as noop, r as create_slot, K as Icon, e as element, C as create_component, f as claim_element, D as claim_component, E as mount_component, u as transition_in, w as transition_out, F as destroy_component, a as space, c as claim_space, H as toggle_class, n as append_hydration_dev, z as update_slot_base, A as get_all_dirty_from_scope, B as get_slot_changes, G as group_outros, x as check_outros } from './client.5c29960b.js';
import { e as exponent, f as formatSpecifier, a as formatPrefix, b as format } from './defaultLocale.de695f5f.js';

/* ../../components/ui/src/icons/feather/ExternalLink.svelte generated by Svelte v3.44.2 */
...
/* ../../components/ui/src/Link.svelte generated by Svelte v3.44.2 */
...
function create_fragment(ctx) {
	...
	let if_block = /*isExternal*/ ctx[12] && /*showIcon*/ ctx[7] && create_if_block(ctx);
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			...
			if (/*isExternal*/ ctx[12] && /*showIcon*/ ctx[7]) {
				if (if_block) {
					if_block.p(ctx, dirty);

					if (dirty & /*isExternal, showIcon*/ 4224) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*theme*/ 512) {
			$$invalidate(11, style = theme.color ? `--color: ${theme.color}` : null);
		}
	};
