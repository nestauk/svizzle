...
function instance($$self, $$props, $$invalidate) {
	...
	setContext('viewport', { _viewId, registerView });
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*currentViewIndex, viewsCount*/ 40) {
			$$invalidate(0, style = makeStyleVars({ currentViewIndex, viewsCount }));
		}
	};
...
class ViewsSlider extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance, create_fragment, safe_not_equal, { viewId: 2 });
