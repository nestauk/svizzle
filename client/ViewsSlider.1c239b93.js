import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, a as space, e as element, t as text, D as create_component, h as head_selector, b as detach_dev, c as claim_space, f as claim_element, g as children, j as claim_text, E as claim_component, k as attr_dev, m as add_location, n as insert_hydration_dev, o as append_hydration_dev, F as mount_component, M as listen_dev, u as transition_in, B as transition_out, G as destroy_component, az as run_all, I as svg_element, J as claim_svg_element, p as noop } from './client.7dada05b.js';
import { V as View } from './View.f93383aa.js';
import { V as ViewsSlider } from './ViewsSlider.2037f48b.js';
import { V as ViewsSliderMarkup } from './markup.e6504f62.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			button1 = claim_element(section0_nodes, "BUTTON", { class: true });
			var button1_nodes = children(button1);
			t3 = claim_text(button1_nodes, "View 2");
			button1_nodes.forEach(detach_dev);
			t4 = claim_space(section0_nodes);
			button2 = claim_element(section0_nodes, "BUTTON", { class: true });
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*$$scope*/ 32) {
				viewsslider_changes.$$scope = { dirty, ctx };
			}
