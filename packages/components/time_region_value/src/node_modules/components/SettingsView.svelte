<script>
	...
	import XorSelector from 'components/XorSelector.svelte';
	import {
		_colorSchemeLabel,
		_colorSchemeLabels,
		toggleColorScheme,
	} from 'stores/colors';
	import {_availableLevels} from 'stores/regionSettings';
	import {
		_currentLevel,
		_focusedRoot,
