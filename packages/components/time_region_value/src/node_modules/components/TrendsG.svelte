<script>
	...
	import {_timelineLayout} from 'stores/layout';
	...
	$: X1 = layout.fullScaleX(data.year_extent[0]);
	$: X2 = layout.fullScaleX(data.year_extent[1]);
	$: x1 = layout.scaleX(data.year_extent[0]);
	$: x2 = layout.scaleX(data.year_extent[1]);
	$: xMed = (x1 + x2) / 2;
